...
extension FCWalletView: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        case ("f1", "coughed"):
            if let cell = tableView.dequeueReusableCell(withIdentifier: "FCWalletImageCell", for: indexPath) as? FCWalletImageCell {
    ...
    func configureCell(_ cell: FCWalletImageCell, with model: ExceptModel) {
        cell.backgroundColor = .clear
        cell.selectionStyle = .none
        cell.model = model
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        switch ourselves {
        case "f1", "f3":
            if let cell = tableView.cellForRow(at: indexPath) as? FCWalletImageCell {
    ...
    func popEnumViewWithModel(_ cell: FCWalletImageCell, _ model: ExceptModel) {
