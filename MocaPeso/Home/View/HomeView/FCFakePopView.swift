...
class FCFakePopView: UIView {
    ...
    lazy var label3: UILabel = {
        let label3 = UILabel.createLabel(font: UIFont(name: Fredoka_Medium, size: 15.px())!, textColor: UIColor.init(css: "#B74C1B"), textAlignment: .left)
